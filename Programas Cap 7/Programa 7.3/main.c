...
void main(void)
{
    char *cad0 = "Buenos días";    /*En este caso se asigna 11 caracteres mas el
    caracter de terminacin '\0' a la posición de memoria ala que apunta la
    variable cad0 -apuntadoe del tipo cadena de caracters */
    ...
    //esta es otra manera para asignar valores a la variable cad3

    char cad4[20], cad5[20], cad6[20];

    printf("ZnLa cadena cad0 es: ");
    puts(cad0);
    ...
    printf("\nIngrese una linea de texto -se lee cada caracter cn getchar-: \n");
