...
void main(void)
{
   ...
   /* La función strchr busca la posición en la que se encuentra un➥   determinado caracter en la cadena de caracteres. Si lo encuentra regresa
