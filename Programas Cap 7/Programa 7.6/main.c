...
void main(void)
{
  ...
  //menor que el de cad0, se genera un error en la ejecución del programa. */
    ...
    de ejecución. */
    printf("\Prueba de la funcion strcpy. Se copian 3 caracteres de cad3 a cad0: %s\n", cad0);


    strcpy(cad1, "YY");
    printf("\Prueba de la funcion strcpy. Se copian 3 caracteres de YY a cad1: %s\n", cad1);

    strcpy(cad2, "");
    strncat(cad2, cad0, 4);
    printf("\Prueba de la funcion strcpy. Se incorporan 4 caracteres de cad0 a cad2: %s\n", cad2);
    ...
    printf("\Prueba de la funcion strstr. Se trata de localizar la cadena Mexico dentro cad0: %s\n", cad0);
