...

{
    if (R1 > R2)
        if (R1 > R3)
            printf ("\nRefión con mayor promedio: Región Golfo. Promedio: %6.2f", R1 / 12);
        ...
        printf ("\nRegion con mayor promedio: Region Pacífico. Promedio: %6.2f", R2 / 12);

    else
        printf("\nRegion con mayor promedio: Región Caribe. Promedio: %6.2f", R3 / 12);
