...
void main(void)
{
    ...
    /*Esta funcion se usa para modificar el promedio de un alumno */
    {
        int d;
        alumno alu;
        printf("\nIngrese l numero de registro que desea modificar: ");
    ...
    scanf("%f", &alu.promedio); //modifica el registro del nuevo promedio
