...
void main(void)
{
    ...
    if ((ar = fopen("C:\\Users\\Gabriel\\Desktop\\Programación\\Gabriel-O.-_PM\\Programas Cap 9\\Programa 9.5\\Doc.txt", "w")) != NULL)
    {
        fprintf(ar, "%d", n); /*Se escribe el numero de alumnos
        en el archivo*/
