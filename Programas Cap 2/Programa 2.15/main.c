...
/* Spa.
El programa, el recibir como datos el tipo de tratamiento, la edad y el
numero de días de internación de un cliente en un spa, calcula el costo
...
void main (void)
{
    int TRA, EDA, DIA;
    float COS;
    printf ("ingrese tipo de tratamiento de edad y dias: ");
