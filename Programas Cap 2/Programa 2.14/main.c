...
/* Teléfono.
El programa, al recibir como datos como la clave de la zona geográfica y el
número de segundos en una llamada telefónica, calcula el costo de la misma.

CLA y TIR: cariables de tipo entero.
