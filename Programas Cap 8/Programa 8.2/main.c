...
tanto para la elctura como para la escritura. Se utiliza además una función que
recibe como parametro un apuntador de tipo estructura */

struct alumno //declara la estructura

{
    ...
    a3 = &a0;   //aqui a  la variable estructura a3 se le asigna la dirección dela variable estrctura alumno, a0,
    ...
    a4 = &a6;
        ...
        de los dos formatos siguientes:
                ...
                o bien
                (apuntador).campo
        En la lctura de los campos de la variable a4 se utilizan como ejemlo ambos formatos */
        ...
        gets(a4->nombre);
        printf("Ingrese la carrera del alunmo 4: ");
        gets((*a4).carrera);

        printf("Ingrese el promedio del alumnno 4: ");
        scanf("%f", &a4->promedio);
        fflush(stdin);
        ...
        Lecturra(a5) /* En este caso se pasa el apuntador de tipo estructura alumno
        ...
        printf("\nDatos del alumno 3\n");
        //Mira como se escriben los campos de los apuntadores de tiop estructura
     ...
     void Lecturra(stricmp alumno a*)
     //esto para leer los campos de un apuntador de tipo estructura alumno
     {
         printf("\nIngrese la matricula del alunmo: ");
         scanf("%d", &(*a).matricula);
         fflush(stdin);
