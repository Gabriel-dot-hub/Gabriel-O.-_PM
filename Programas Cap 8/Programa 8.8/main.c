...
//Hospital.
//El programa genera a información acerca de los pacientes de un hospital.
...
break;
        ...
        printf("\nNumero de pacientes en condición 1: %d", C1);
        printf("\nNumero de pacientes en condición 2: %d", C2);
        printf("\nNumero de pacientes en condición 3: %d", C3);
        printf("\nNumero de pacientes en condición 4: %d", C4);
        printf("\nNumero de pacientes en condición 5: %d", C5);
}
