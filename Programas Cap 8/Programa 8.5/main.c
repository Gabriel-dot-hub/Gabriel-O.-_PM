...
void main(void)
{
    alumno a1 = {120, "Maria", "Contabilidad", 8.9, "8-158-40-50"}, a2, a3;
    ...
    printf("Ingrese la carrera la carrera: ");
    gets(a2.carrera);

    printf("Ingrse el promedio: ");
    scanf("%f", &a2.promedio);
    fflush(stdin);
    ...
    printf("Alumno 3\n");
    Lectura(&a3); //se llama una funcion para leer los campos de la variable a3
    ...
    srtcpy(a0.personales.correo, "hgimenez@hotmail.com");
    ...
    printf("Ingrese el tenefono celular del alumno 2: ");
    fflush(stdin);
    gets(a2.personales.celular);

        puts(a2.personales.celular);  //Escribe el telefono ingresado
        puts(a2.personales.correo);     //EN esta escribe la basura
    ...
    puts(a3.personales.correo); //Pone basura
}
