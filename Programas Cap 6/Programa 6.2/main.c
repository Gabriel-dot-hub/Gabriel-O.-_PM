...
void Imprime(int[][MAX], int, int);
    ...
    while(FIL > MAX || FIL < 1);
    //verifica el numero de filas que sea correcto
    ...
    //Lectura funciona para leer un arreglo bidimensional entero de F filas y C columanas
    ...
    //Suma se usa para sumar los arreglos y almacenar el resultado en un tercer arreglo bidimensional
    {
        int I, J;
        for (I = 0; I < F; I++)
            for(J = 0; J < C; J++)
