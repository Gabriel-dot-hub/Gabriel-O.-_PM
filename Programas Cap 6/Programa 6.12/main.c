...
const int PRO = 24;
const int MES = 12;
const int ANO = 10;     //cambié AÑO por ANO porque no reconoce la Ñ el complilador y da error
...

{
    ...
    printf("\n\nProvincia con mayot registro de lluvias: %d", EMAY + 1);
    printf("\nRegistro: %.2f", ELLU);
}
...

{
    ...
    printf("\n\nProvincia con menor registro anual de lluvias en el año: %d", EMEN + 1);
