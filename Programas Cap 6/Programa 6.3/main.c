...
//Se declaran las constantes para la fila y la profundidad
...
//prototipo de funciones que equivalen a cada inciso
...

{
    ...
    printf("\n\nCarrera con mayor número de alumnos: %d lumnos: %d", CAR + 1, MAY);
}
