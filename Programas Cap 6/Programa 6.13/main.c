...
ventas en el último año. Genera además el importe de las ventas. */
{
    ...
    if (SUM1 > SUM2)
        if (SUM1 > SUM3)
        {
            printf("\n\nDepartamento con mayorres ventas en el ultimo año: Hilos");
            printf("  Ventas:%.2f", SUM1);

        }
        else
        {
            printf("\n\nDepartamento con mayorres ventas en el ultimo año: Licra");
            printf("  Ventas:%.2f", SUM3);
        }
    else if (SUM2  > SUM3)
    {
        printf("\n\nDepartamento con mayorres ventas en el ultimo año: Lanas");
